'use client';
import { useAddNewServiceAreasMutation, useGetAllServiceAreasQuery, useUpdateServiceAreaMutation } from '@/redux/features/serviceArea/serviceAreaApi';
...
const AreasWeServe = () => {
    ...
    const[addNewServiceAreasMutation] = useAddNewServiceAreasMutation()
